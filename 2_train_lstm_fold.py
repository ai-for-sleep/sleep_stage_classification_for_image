...
for i, (train_idx, valid_idx) in enumerate(kf.split(train_patients)):
    CONV_PATH = f'checkpoints/resnet101_224_fold_{i}.pth'
    SAVE_PATH = f'checkpoints/resnet101_lstm_224_fold_{i}.pth'
    ...
    train_dataset = SleepSeqDataset(
        train_patients_fold, DATA_PATH, LABEL_NAME, SEQ_LEN, train_transforms)
    valid_dataset = SleepSeqDataset(
        valid_patients_fold, DATA_PATH, LABEL_NAME, SEQ_LEN, valid_transforms)
